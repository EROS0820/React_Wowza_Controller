...
import FlagIcon from '../../images/icon_flag.svg';
...
const Register = (props) => {
    ...
    const handleDone = event => {
        if(!formValue.isValid || !checkCountry) {
            return;
        }
        
        const user = JSON.parse(localStorage.getItem("user"))
        if(!user) {
            setErrorMsg("Can't get user information");
            return;
        }
        
        setVisibleIndicator(true);
        Service.update_user(user.id, formValue.values.last_name, formValue.values.first_name, country).then(
            response => {
                    ...
                    <div className={classes.div_sign}>
                        <div className={classes.root}>
                            ...
                            <div className={classes.div_title}>
                                <span className={classes.title}>Fill your details</span>
                            </div>
                            <ShadowInput
                                ...
                                startAdornment={
                                    <InputAdornment position="start">
                                        <img className={classes.icon_insert} src={UserIcon}/>
                                    </InputAdornment>
                                }
                            />
                            <ShadowInput
                                ...
                                renderInput={(params) => 
                                    <TextField 
                                        ...
                                        InputProps={{
                                            ...
                                            startAdornment: (
                                                <InputAdornment position="start">
                                                    <img className={classes.icon_insert_flag} src={FlagIcon}/>
                                                </InputAdornment>
                                            ),
                                        }}
                                    />
                            ...
                            <div className={classes.div_sign_button}>
                                <RedButton onClick={handleDone} className={formValue.isValid && checkCountry ? classes.button : classes.button_disable}>Done</RedButton>
                            </div>
                        </div>
                    </div>
                </div>
